...
public partial class frmViewStatus1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        /*
        if ((string)Session["Previlege"] != "User" || (string)Session["Previlege"] != "Admin" || (string)Session["Previlege"] != "Washer")
        {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                lblStatus.Text = "No update currently available.  Please contact support if the issue persists.";
            }
